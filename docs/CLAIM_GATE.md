...
- `scripts/fixtures/claim-taxonomy.json` covers positive, negated, boundary, and false-positive cases.
- `scripts/check-claim-taxonomy.mjs` runs from the evidence build before public trust outputs are generated.
