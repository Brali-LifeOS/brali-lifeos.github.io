...
console.log(`Adoption surfaces generated: ${(config.runtimes || []).length} runtime recipes, ${evaluation.case_count} reproducible evaluation cases, citation contract for ${config.citation.author}, hosted_remote_mcp=${config.mcp.hosted_remote}.`);
