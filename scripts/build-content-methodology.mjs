...
console.log(`Content methodology page generated with ${indexing.indexable_count} discovery-ready, ${indexing.withheld_count} withheld, ${claimCounts.debt_entries ?? 0} claim-debt record(s), ${claimCounts.indexable_debt_entries ?? 0} indexable claim-debt record(s), ${topicDebtGroupCount} Topic debt group(s), and ${normalizations.rules.length} reviewed normalization rule(s).`);
