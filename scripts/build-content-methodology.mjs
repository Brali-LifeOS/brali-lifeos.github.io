...
console.log(`Content methodology page generated with ${indexing.indexable_count} discovery-ready, ${indexing.withheld_count} withheld, and ${normalizations.rules.length} reviewed normalization rule(s).`);
