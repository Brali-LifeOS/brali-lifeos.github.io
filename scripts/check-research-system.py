...
areas=load("data/life-areas.json"); zones=load("data/life-os-zones.json"); ontology=load("data/knowledge-ontology.json"); queries=load("data/research-queries.json"); queue=load("data/research-candidates.json")
...
print(f"research-system check passed: {len(query_ids)} ontology-mapped queries, {len(candidate_ids)} ontology-mapped candidates; source provenance enforced")
