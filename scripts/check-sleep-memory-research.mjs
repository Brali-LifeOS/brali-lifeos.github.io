...
if (decisions.count !== 2) failures.push(`expected 2 published evidence decisions, got ${decisions.count}`);
...
if (!wakeDecision?.limitations?.length || !sleepDecision?.limitations?.length) failures.push("evidence decisions must preserve limitations");
...
console.log(`Sleep/memory research verified: 2 evidence decisions, wakeful-rest protocol reviewed and trusted, sleep variability retained as watch.`);
