...
if (invalid || missingLastmod || prematureCitations) {
  throw new Error(`Structured data validation failed: invalid pages=${invalid}, missing article lastmod=${missingLastmod}, premature citations=${prematureCitations}.`);
}
console.log(`Structured data verified for ${index.length} Growth Library entries; citations are exposed only for reviewed material.`);
