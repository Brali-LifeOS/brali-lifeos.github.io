...
const routes=["/research/","/research/habits-take-time/","/research/rag-is-not-a-trust-button/","/research/sleep-regularity-signal-not-prescription/","/research/retrieval-practice-memory-is-not-application/","/for-ai/","/agents/","/faq/","/partners/","/terms/"];
