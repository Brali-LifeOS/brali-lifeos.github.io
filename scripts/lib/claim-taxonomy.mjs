const definitions = [
  {
    id: 'quantitative',
    enforced: true,
    description: 'Percentages, sample sizes, participant counts, or common effect estimates that require precise source support.',
    patterns: [
      /\b\d{1,3}(?:\.\d+)?\s*%/i,
      /\bn\s*=\s*\d+\b/i,
  ...
  },
  {
    ...
    enforced: true,
    description: 'Claims about Brali, author, user, pilot, trial, experiment, study, or internal data results.',
    patterns: [
